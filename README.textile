...
h2. I have changed source code base on mobz/elasticsearch-head,Thanks for mobz and other contributors!
...
* for Elasticsearch 6.x: @docker run -p 9100:9100 haitiandocker/elasticsearch-head:6@
